...
public enum UnidadDeMedida {
	...
	public void setCantidadDeLaUnidadDeBase(double cantidadDeLaUnidadDeBase) {
		this.cantidadDeLaUnidadDeBase = cantidadDeLaUnidadDeBase;
	}
	...
	public double convertirTemperatura(double cantidad, UnidadDeMedida nuevaUnidadDeMedida) {		
		if(this.nombre.equals(nuevaUnidadDeMedida.nombre)) {
			return cantidad;
		}
		else {
			if(nuevaUnidadDeMedida.nombre.equals("Grado/s Celsius")){
				cantidad =  cantidad * 1.8 + 32;
				return cantidad;
			}
			else if(nuevaUnidadDeMedida.nombre.equals("Grado/s Farenheit")){
				cantidad =  (cantidad - 32) / 1.8;
				return cantidad;
			}				
			else {
