 ...
 */
@Constraint(validatedBy = ProductoExisteEnDBValidador.class)
@Retention(RUNTIME)
@Target({ElementType.TYPE, FIELD, METHOD })
public @interface ProductoExisteEnDB {
	String message() default "Ya existe un producto con ese nombre, debe elegir otro.";
